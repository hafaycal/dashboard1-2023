...
# LOAD DATA
data = pd.read_csv("data/data_original.csv", index_col='SK_ID_CURR')
...
#model = joblib.load("models/model_0.21.3.pkl")
model1 = joblib.load("models/classifier_rf_model.sav",)
# Load the surrogate model
surrogate_model = joblib.load("models/preprocessor.sav")
